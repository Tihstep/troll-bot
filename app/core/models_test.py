...
class TelegramBotService:
    ...
    def process_image(self, image_path: str) -> str:
        ...
        response = self.client.chat.completions.create(
            model="gpt-4-turbo",  # Используем модель для обработки изображений
            messages=[
                {
                    "role": "user",
                    "content": [
    ...
    def _generate_prompt(self, context: str, hate_msg: str) -> tuple[str, str]:
        ...
        Далее я приведу хорошие и плохие примеры комментариев как нужно отвечать и не нужно отвечать: пока не готово позже заполню
